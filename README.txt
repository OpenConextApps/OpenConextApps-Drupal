...
3. SURFconext certificates. You need to apply for SP (Service Provider) to connect to the SURFconext infrastructure. For more information, send email to surfconext-beheer@surfnet.nl or visit https://wiki.surfnetlabs.nl/display/surfconextdev/
